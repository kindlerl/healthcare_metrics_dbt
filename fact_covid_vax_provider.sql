...
deduplicated AS (
    SELECT
        ...
        TRIM(STATE) AS state,
        TRIM(PERCENT_OF_RESIDENTS_WHO_ARE_UP_TO_DATE_ON_THEIR_VACCINES) AS percent_of_residents_who_are_up_to_date_on_their_vaccines,
        TRIM(PERCENT_OF_STAFF_WHO_ARE_UP_TO_DATE_ON_THEIR_VACCINES) AS percent_of_staff_who_are_up_to_date_on_their_vaccines,
